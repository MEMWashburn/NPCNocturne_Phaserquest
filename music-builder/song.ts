...
export class Song extends EditableObject {
  ...
  /** The project that includes this song */
  private parent?: MusicProject;
  ...
  /** Sets the parent project of this song
   * Parent projects are usd to resolve themes in the case the song is set to "Use Parent Theme"
   */
  public setProject(project: MusicProject) {
    this.parent = project;
  }
  ...
  public getResolvedTheme(): ProjectTheme {
    if (this.theme === SongTheme.UseParent) {
      return this.parent ? this.parent.getTheme() : SongTheme.Fantasy;
    }
    return this.theme;
  }
